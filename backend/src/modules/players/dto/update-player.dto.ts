...
export class UpdatePlayerDto {
  @ApiPropertyOptional({ description: 'Nombre del jugador', maxLength: 100 })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  first_name?: string;

  @ApiPropertyOptional({ description: 'Apellido del jugador', maxLength: 100 })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  last_name?: string;
  ...
  @ApiPropertyOptional({ description: 'Pierna hábil (left/right)' })
  @IsOptional()
  @IsString()
  strong_foot?: string;
